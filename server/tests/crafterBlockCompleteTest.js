/**
 * Complete test suite for CrafterBlock using real implementations
 */
...
describe('CrafterBlock Complete Tests', () => {
  let crafterBlock;
  let world;
  let recipeManager;
  ...
  describe('Recipe Memory System', () => {
    ...
    it('should clear recipe memory when requested', () => {
      // Set crafting mode to template
      crafterBlock.setCraftingMode('template');
    ...
    it('should correctly check if inventory matches recipe memory', () => {
      // Set crafting mode to template
      crafterBlock.setCraftingMode('template');
      ...
      crafterBlock.placeItem(0, { id: 'stone', count: 1 });

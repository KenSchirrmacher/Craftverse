/**
 * SuspiciousSandBlock - Implementation of suspicious sand blocks for archaeology
 */

const BaseBlock = require('../blocks/baseBlock');

class SuspiciousSandBlock extends BaseBlock {
  constructor(options = {}) {
    super({
      id: 'suspicious_sand',
   ...
   * @returns {SuspiciousSandBlock} New block instance
   */
  static fromJSON(data) {
    const block = new SuspiciousSandBlock(data);
...
module.exports = SuspiciousSandBlock; 